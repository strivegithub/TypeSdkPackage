...
public class TypeSDKEventManager
{
	...
	public void SendUintyEvent(String recevierFuncName,String sendData)
	{
		...
		UnityPlayer.UnitySendMessage(TypeSDKDefine.UNITY_RECIVER, recevierFuncName, sendData);
	}
	...
	public void SendEvent(String _in_eventType,String recevierFuncName,String sendData,String platformName){
	...
	public void AddEventListener(String _in_eventType, TypeSDKEventListener _in_listener)
	{
		ArrayList<TypeSDKEventListener> list =  listenerMap.get(_in_eventType);
		if(null==list)
		{
