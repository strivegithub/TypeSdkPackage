...
public final class TypeSDKDefine {
	...
	public final static class AttName {
		...
		public static final String REDIRECT_URI = "redirect_uri"; // 陌陌的 redirect uri
		public static final String SECRET_KEY = "secret_key"; // 应用的 secret key
		public static final String CHANNEL_ID = "channel_id"; // 应用的 渠道id
		public static final String PAY_KEYSTORE = "pay_keystore"; // 支付用的 keystore密码
		...
		public static final String BUNDLE_NAME = "bundle_name"; // ios中的应用（bundle name）
		public static final String PRODUCT_PACKAGE_NAME = "product_package_name"; // 安卓中应用的包名
		public static final String PRODUCE_KEY = "product_key"; // 应用的product key
		public static final String PRODUCT_ID = "product_id"; // 应用的 product id
		public static final String BUNDLE_DISPLAY_NAME = "bundle_display_name"; // iso中应用的 bundle display name
		...
		public static final String PUSH_TYPE_DATA = "push_type_data";	//推送类型的可自定义内容 string
		public static final String PUSH_ID = "push_id";		//推送的id  int 1,2,3...同一id下推送唯一
		public static final String PUSH_TITLE = "push_title";	//推送的标题 string xxxx
		public static final String PUSH_INFO = "push_info";		//推送的内容 string xxxx
		public static final String PUSH_TICKER = "push_ticker";	   //推送在通知栏出现时显示的内容 String xxxx
		...
		public static final String COLLECT_SDK = "collect_sdk";// 具体列表为 约定的SDK_NAME
		...
		public static final String USER_STATIC_TIMER = "user_static_timer";//用户行为统计 定时
		public static final String USER_STATIC_CURRENT = "user_static_current";//用户行为统计 实时
		public static final String USER_STATIC_KEY = "user_static_key";//用户行为统计 key
