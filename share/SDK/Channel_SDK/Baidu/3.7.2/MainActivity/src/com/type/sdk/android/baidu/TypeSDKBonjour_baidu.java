...
public class TypeSDKBonjour_baidu extends TypeSDKBaseBonjour {
	...
	private static class SingletonHandler {
		static final TypeSDKBonjour_baidu instance = new TypeSDKBonjour_baidu();
	}
	
	public static TypeSDKBonjour_baidu Instance(){
...
//					notify_baidu.Logout();
					...
					data.CopyAtt(TypeSDKBonjour_baidu.Instance().platform, AttName.CP_ID);
					data.CopyAtt(TypeSDKBonjour_baidu.Instance().platform, AttName.SDK_NAME);
					data.CopyAtt(TypeSDKBonjour_baidu.Instance().platform, AttName.PLATFORM);
