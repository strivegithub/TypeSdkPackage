...
public class TypeSDKBonjour_xiaomi extends TypeSDKBaseBonjour {
	...
	private static class SingletonHandler {
		static final TypeSDKBonjour_xiaomi instance = new TypeSDKBonjour_xiaomi();
	}
	
	public static TypeSDKBonjour_xiaomi Instance(){
...
//									System.exit(0);
	...
	private void xiaomiPay(PayInfoData _in_pay) {
		...
		TypeSDKLogger.e( "S_ID:" + (userInfo.GetData(AttName.SERVER_NAME).length() == 0 ? userInfo.GetData(AttName.SERVER_ID) : 
			userInfo.GetData(AttName.SERVER_NAME)));
		MiCommplatform.getInstance().miUniPay(UnityPlayer.currentActivity,
