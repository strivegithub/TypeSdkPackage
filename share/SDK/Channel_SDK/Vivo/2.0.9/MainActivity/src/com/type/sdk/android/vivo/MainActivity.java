...
//	
    ...
    protected void onCreate(Bundle savedInstanceState){
    	...
    	String result="";
    	result +="~"+ TypeSDKBonjour_vivo.Instance().isHasRequest(TypeSDKDefine.AttName.REQUEST_INIT_WITH_SEVER);
    	result +="~"+ TypeSDKBonjour_vivo.Instance().isHasRequest(TypeSDKDefine.AttName.SUPPORT_PERSON_CENTER);
    	result +="~"+ TypeSDKBonjour_vivo.Instance().isHasRequest(TypeSDKDefine.AttName.SUPPORT_SHARE);
        
    	
    	TypeSDKLogger.i("result "+result);
    	TypeSDKUpdateManager update = new TypeSDKUpdateManager(this, 
    			TypeSDKBonjour_vivo.Instance().platform.GetData(AttName.CHANNEL_ID), TypeSDKBonjour_vivo.Instance().platform.GetData("check_update_url"));
...
//					 TypeSDKBonjour_vivo.Instance().platform.GetData(AttName.APP_ID);
...
//    }
    ...
    protected void onDestroy(){
    	...
    	TypeSDKBonjour_vivo.Instance().onDestroy();
    ...
    {
    	super.onResume();
    	TypeSDKBonjour_vivo.Instance().onResume(_in_context);
    }
	...
	protected void onStop() {
		// TODO Auto-generated method stub
		super.onStop();
		TypeSDKBonjour_vivo.Instance().onStop();
	}
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		TypeSDKBonjour_vivo.Instance().onPause();
	}
    ...
    {
    	String _in_data = "";    	
    	TypeSDKBonjour_vivo.Instance().initSDK(_in_context,_in_data);
    }
    /**
     * 通知账号登录
     * @param _in_context
    ...
    public  void CallLogin(String _in_data)
    {
    	...
    	TypeSDKBonjour_vivo.Instance().ShowLogin(_in_context, _in_data);
    ...
    {
    	TypeSDKBonjour_vivo.Instance().ShowLogout(_in_context);
    }
    /***
     * 
    ...
    public  String CallExchangeItem(final String _in_data)
    {
		...
		return TypeSDKBonjour_vivo.Instance().ExchangeItem(_in_context, _in_data);
    }
    ...
    {
    	TypeSDKBonjour_vivo.Instance().ShowToolBar(_in_context);
    }
    public void CallHideToolBar()
    {
    	TypeSDKBonjour_vivo.Instance().HideToolBar(_in_context);
    }
    /***
    ...
    {
    	TypeSDKBonjour_vivo.Instance().ShowPersonCenter(_in_context);
    }
    public void CallHidePersonCenter()
    {
    	TypeSDKBonjour_vivo.Instance().HidePersonCenter(_in_context);
    }
    public void CallShare(String _in_data)
    {
    	TypeSDKBonjour_vivo.Instance().ShowShare(_in_context, _in_data);
    }
    public void CallSetPlayerInfo(String _in_data)
    {
    	TypeSDKBonjour_vivo.Instance().SetPlayerInfo(_in_context, _in_data);
    }
    public void CallExitGame()
    {
    	TypeSDKBonjour_vivo.Instance().ExitGame(_in_context);
    }
    ...
    {
    	return TypeSDKBonjour_vivo.Instance().LoginState(_in_context);
    }
    public String CallUserData()
    {
    	return TypeSDKBonjour_vivo.Instance().GetUserData();
    }
    public String CallPlatformData()
    {
    	return TypeSDKBonjour_vivo.Instance().GetPlatformData();
    }
    public boolean CallIsHasRequest(String _in_data)
    {
    	return TypeSDKBonjour_vivo.Instance().isHasRequest(_in_data);
    }
    
    public String CallAnyFunction(String FuncName,String _in_data)
    {
    	Method[] me = TypeSDKBonjour_vivo.Instance().getClass().getMethods();
    	for(int i = 0;i<me.length;++i)
    	{
    		if(me[i].getName().equals(FuncName))
    		{
    			try 
    			{
					return (String) me[i].invoke(TypeSDKBonjour_vivo.Instance(),_in_context ,_in_data);
	...
	public void AddLocalPush(String _in_data)
    {
    	...
    	TypeSDKBonjour_vivo.Instance().AddLocalPush(_in_context, _in_data);
    }
    
    public void RemoveLocalPush(String _in_data)
    {
    	TypeSDKLogger.i(_in_data);
    	TypeSDKBonjour_vivo.Instance().RemoveLocalPush(_in_context, _in_data);
    }
    
    public void RemoveAllLocalPush()
    {
    	
    	TypeSDKBonjour_vivo.Instance().RemoveAllLocalPush(_in_context);
    }
