...
import com.type.sdk.android.oppo.TypeSDKBonjour_oppo;
...
public class TypeApplication extends Application{
	...
	public void onCreate() { 
    	...
    	if(buffStr.length()>0)
    	{
    		TypeSDKBonjour_oppo.Instance().platform.StringToData(buffStr);
    		TypeSDKLogger.i(TypeSDKBonjour_oppo.Instance().platform.DataToString());
    	}
	}
