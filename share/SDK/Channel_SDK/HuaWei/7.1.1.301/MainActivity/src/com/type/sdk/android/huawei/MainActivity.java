...
public class MainActivity extends BaseMainActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
    	...
    	String result="";
    	result +="~"+ TypeSDKBonjour_huawei.Instance().isHasRequest(TypeSDKDefine.AttName.REQUEST_INIT_WITH_SEVER);
    	result +="~"+ TypeSDKBonjour_huawei.Instance().isHasRequest(TypeSDKDefine.AttName.SUPPORT_PERSON_CENTER);
    	result +="~"+ TypeSDKBonjour_huawei.Instance().isHasRequest(TypeSDKDefine.AttName.SUPPORT_SHARE);
...
//        		TypeSDKBonjour_huawei.Instance().platform.GetData(AttName.CHANNEL_ID), TypeSDKBonjour_huawei.Instance().platform.GetData("check_update_url"));
//        update.checkUpdateInfo();
    ...
    protected void onDestroy()
    {
    	...
    	TypeSDKBonjour_huawei.Instance().onDestroy();
    }
    ...
    {
    	super.onResume();
    	TypeSDKBonjour_huawei.Instance().onResume(_in_context);
	...
	protected void onPause() {
		...
		super.onPause();
		TypeSDKBonjour_huawei.Instance().onPause();
	}
    ...
    public  void CallInitSDK()
    {
    	...
    	TypeSDKBonjour_huawei.Instance().initSDK(_in_context,_in_data);
    }
    /**
     * ���ⲿ call�� login����
     * @param _in_context
    ...
    public  void CallLogin(String _in_data)
    {
    	...
    	TypeSDKBonjour_huawei.Instance().ShowLogin(_in_context,_in_data);
    }
    /**
     * ���ⲿ call ��logout����
     * @param _in_context
    ...
    {
    	TypeSDKBonjour_huawei.Instance().ShowLogout(_in_context);
    }
    /***
     * 
    ...
    public  String CallPayItem(final String _in_data)
    {
    	...
    	new Thread() {
			...
			public void run() {
				String payMessage;
				try {
					payMessage = HttpUtil.http_get(TypeSDKBonjour_huawei
							.Instance().platform
							.GetData(AttName.SWITCHCONFIG_URL));
					if (((payMessage.equals("") || payMessage.isEmpty()) && openPay)
							|| TypeSDKTool.openPay(TypeSDKBonjour_huawei
									.Instance().platform
									.GetData(AttName.SDK_NAME), payMessage)) {
						TypeSDKBonjour_huawei.Instance().PayItem(_in_context,
								_in_data);
					} else {
						TypeSDKNotify_huawei notify = new TypeSDKNotify_huawei();
    ...
    {
    	return TypeSDKBonjour_huawei.Instance().ExchangeItem(_in_context, _in_data);
    }
    /***
     * ���ⲿ���õ� ��ʵ����������
     * @param _in_context
    ...
    {
    	TypeSDKBonjour_huawei.Instance().ShowToolBar(_in_context);
    }
    public void CallHideToolBar()
    {
    	TypeSDKBonjour_huawei.Instance().HideToolBar(_in_context);
    }
    /***
     * ���ⲿ���õ���ʵ�û����ĺ���
     * @param _in_context
    ...
    {
    	TypeSDKBonjour_huawei.Instance().ShowPersonCenter(_in_context);
    }
    public void CallHidePersonCenter()
    {
    	TypeSDKBonjour_huawei.Instance().HidePersonCenter(_in_context);
    }
    public void CallShare(String _in_data)
    {
    	TypeSDKBonjour_huawei.Instance().ShowShare(_in_context, _in_data);
    }
    public void CallSetPlayerInfo(String _in_data)
    {
    	TypeSDKBonjour_huawei.Instance().SetPlayerInfo(_in_context, _in_data);
    }
    public void CallExitGame()
    {
    	TypeSDKBonjour_huawei.Instance().ExitGame(_in_context);
    }
    ...
    {
    	return TypeSDKBonjour_huawei.Instance().LoginState(_in_context);
    }
    public String CallUserData()
    {
    	return TypeSDKBonjour_huawei.Instance().GetUserData();
    }
    public String CallPlatformData()
    {
    	return TypeSDKBonjour_huawei.Instance().GetPlatformData();
    }
    public boolean CallIsHasRequest(String _in_data)
    {
    	return TypeSDKBonjour_huawei.Instance().isHasRequest(_in_data);
    }
    
    public String CallAnyFunction(String FuncName,String _in_data)
    {
    	Method[] me = TypeSDKBonjour_huawei.Instance().getClass().getMethods();
    	for(int i = 0;i<me.length;++i)
    	{
    		if(me[i].getName().equals(FuncName))
    		{
    			try 
    			{
					return (String) me[i].invoke(TypeSDKBonjour_huawei.Instance(),_in_context ,_in_data);
	...
	public void AddLocalPush(String _in_data)
    {
    	...
    	TypeSDKBonjour_huawei.Instance().AddLocalPush(_in_context, _in_data);
    }
    
    public void RemoveLocalPush(String _in_data)
    {
    	TypeSDKLogger.i(_in_data);
    	TypeSDKBonjour_huawei.Instance().RemoveLocalPush(_in_context, _in_data);
    }
    
    public void RemoveAllLocalPush()
    {
    	
    	TypeSDKBonjour_huawei.Instance().RemoveAllLocalPush(_in_context);
    }
