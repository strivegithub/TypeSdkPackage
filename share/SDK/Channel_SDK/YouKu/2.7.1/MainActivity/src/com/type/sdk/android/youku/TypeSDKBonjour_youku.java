...
public class TypeSDKBonjour_youku extends TypeSDKBaseBonjour {

	public Context appContext;
	public Activity appActivity;
	
	private static class SingletonHandler {
		static final TypeSDKBonjour_youku instance = new TypeSDKBonjour_youku();
	}
	
	public static TypeSDKBonjour_youku Instance(){
		...
		mainHandler.post(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					new YKInit(UnityPlayer.currentActivity).init(new YKCallBack() {
