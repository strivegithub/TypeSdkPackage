...
public class TypeSDKBonjour_downjoy extends TypeSDKBaseBonjour {
	...
	private static class SingletonHandler {
		static final TypeSDKBonjour_downjoy instance = new TypeSDKBonjour_downjoy();
	}
	
	public static TypeSDKBonjour_downjoy Instance(){
...
//                    	   downjoyLogin();
	...
	private void downjoyPay(final PayInfoData _in_pay) {
		Handler mainHandler = new Handler(Looper.getMainLooper());
	    mainHandler.post(new Runnable(){
	       @Override
	       public void run() {
			...
			// 打开支付界面,获得订单号
            downjoy.openPaymentDialog(appActivity, price, _in_pay.GetData(AttName.ITEM_NAME), 
            		_in_pay.GetData(AttName.ITEM_DESC), _in_pay.GetData(AttName.BILL_NUMBER), 
            		_in_pay.GetData(AttName.SERVER_NAME), _in_pay.GetData(AttName.ROLE_NAME), new CallbackListener<String>() {
