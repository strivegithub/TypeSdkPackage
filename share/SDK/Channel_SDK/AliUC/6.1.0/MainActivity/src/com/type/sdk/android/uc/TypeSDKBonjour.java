...
public class TypeSDKBonjour extends TypeSDKBaseBonjour {
	...
	SDKEventReceiver receiver = new SDKEventReceiver() {
		...
		private void onCreateOrderSucc(OrderInfo orderInfo) {
			if (orderInfo != null) {
				 ...
				 TypeSDKData.PayResultData payResult = new
				 TypeSDKData.PayResultData();
	...
	protected void SdkPay(Context _in_context, TypeSDKData.PayInfoData _in_pay) {
		...
		try {
			String signString = "accountId=" + user_id 
					+ "amount="	+ priceString
					+ "cpOrderId=" + cpOrderId
					+ "notifyUrl=" + notifyUrl;
			...
			orderSign.SetData("subject", URLEncoder.encode(signString, "UTF-8"));
			
			String clientSign = "253|1|1|" + URLEncoder.encode(signString, "UTF-8") + "|clientKey";
